                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="CrearTema?accion=Eliminar&eliminarTema=<%= tema.getId() %>" class="btn btn-danger" 
                                                           onclick="return confirm('¿Estás seguro de que deseas eliminar este tema?');">Eliminar</a>
                                                    </td>                                            
                                                </tr>
                                                <% } %>
                                            </tbody>
