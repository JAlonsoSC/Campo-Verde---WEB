...
<head>
    ...
    <title>Ver Tema - Campo Verde</title>
            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        <a class="sidebar-link" href="forum.jsp">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3"><strong>Tema: ${tema.titulo}</strong></h1>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <c:forEach var="mensaje" items="${mensajes}">
                                        <div class="border-bottom mb-3 pb-3">
                                            <p class="mb-1"><strong>${mensaje.autor}</strong> dice:</p>
                                    ...
                                    <form action="CrearMensaje" method="POST">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Escribe tu mensaje" name="contenidoMensaje">
