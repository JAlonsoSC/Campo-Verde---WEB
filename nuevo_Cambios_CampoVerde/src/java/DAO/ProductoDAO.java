...
public class ProductoDAO {
    ...
    public void listarImg(int id, HttpServletResponse response) {
     ...
     public boolean actualizarEmpleado(Producto producto) {
        String sql = "UPDATE empleado SET Nombre = ?, Categoria = ?, Descripcion = ?, Precio = ?, Foto = ?, Disponibilidad = ? WHERE IdEmpleado = ?";
        try (Connection conn = ConexionDB.getInstancia().getConnection(); 
