            ...
            <div class="container">
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px;">
                    <div class="d-inline-flex text-dark">
                        <p class="m-0 text-uppercase"><a class="text-dark" href="proveedor.jsp">Proveedores</a></p>
            ...
            <div class="col-6" style="flex: 1; display: flex; align-items: center;">
                ...
                <div style="width: 100%;">
                    ...
                    <div class="container" style="max-width: 600px; margin: 0 auto;">
                        <form action="https://formsubmit.co/alonsosuana26@gmail.com" method="post" >
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        <div id="confirmacion" class="alert alert-success mt-4" style="display: none;">
