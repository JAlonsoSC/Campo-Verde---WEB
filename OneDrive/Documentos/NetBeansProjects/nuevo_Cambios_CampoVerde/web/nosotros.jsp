...
<html lang="es">
    ...
    <head>
        ...
        <script>
            // Función para expandir el contenido al hacer clic en "Ver Más"
            function toggleExpand(section) {
                const moreText = document.getElementById(section + "-more");
                const btnText = document.getElementById(section + "-btn");
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 pt-5 pb-lg-5 text-justify">
                        <h1 class="m-0 text-primary"><span class="text-dark">Agropecuaria - Campo </span>Verde</h1>
                        <br>
                        <p>Agropecuaria Campo Verde es una empresa destacada en la producción de genética Nelore y carne bovina en el nordeste de la Región Oriental. La empresa se ha adaptado a la globalización con representantes en múltiples países, enfocados en abrir nuevos mercados para sus productos de alta calidad.</p>
                        <p>Desde 1996, hemos apostado por la producción sostenible de ganado Nelore en Canindeyú, empleando tecnología avanzada y prácticas modernas. Nos destacamos en indicadores como la fertilidad reproductiva, la precocidad sexual, la ganancia diaria de peso por animal, la densidad ganadera, y la eficiencia en el transporte terrestre y fluvial.</p>
                        <p>Agropecuaria Campo Verde es un líder en agroganadería sostenible, basado en prácticas óptimas de pastoreo, nutrición animal, manejo del rebaño y bienestar animal. Ofrecemos un paquete tecnológico rentable que beneficia a empresarios de todos los tamaños en el sector ganadero de Canindeyú y otras regiones del país.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="img/foro2.png" style="object-fit: cover;">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex mb-8 mb-lg-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div id="mision-more" style="display: none;">
                                ...
                                <div class="text-center">
                                    <button id="mision-btn" class="btn btn-link text-primary" onclick="toggleExpand('mision')">Ver Más</button>
                                </div>  
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex mb-8 mb-lg-4">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="">Visión</h5>
                                <div id="vision-short">
                                    <p class="m-2"><span class="text-dark">- Mantendrá su posición de liderazgo nacional en la exportación de productos agrícolas y ganaderos.</span></p>
                                </div>
                                <div id="vision-more" style="display: none;">
                                ...
                                <div class="text-center">
                                    <button id="vision-btn" class="btn btn-link text-primary" onclick="toggleExpand('vision')">Ver Más</button>
                                </div>   
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex mb-8 mb-lg-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div id="valores-more" style="display: none;">
                                ...
                                <div class="text-center">
                                    <button id="valores-btn" class="btn btn-link text-primary" onclick="toggleExpand('valores')">Ver Más</button>
                                </div>   
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-center">
                <video width="100%" height="auto" controls>
                    <source src="img/Agropecuaria22.mp4" type="video/mp4">
                </video>
            </div>
        </div>
        <!-- Video -->
        ...
        <div class="container-fluid py-5">
            <div class="container pt-5 pb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="destination-item position-relative overflow-hidden mb-2">
                            <img class="img-fluid fixed-size" src="img/certificaciones-14.png" alt="">
                            <a class="destination-overlay text-white text-decoration-none" href="#"></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="destination-item position-relative overflow-hidden mb-2">
                            <img class="img-fluid fixed-size" src="img/certificaciones-15.jpg" alt="">
                            <a class="destination-overlay text-white text-decoration-none" href="#"></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
